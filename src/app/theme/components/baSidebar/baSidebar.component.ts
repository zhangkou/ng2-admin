...
import {MENU, MENU2} from '../../../../app/app.menu';
...
export class BaSidebar {
  ...
  constructor(private _elementRef:ElementRef, private _state:GlobalState, private appState: AppState) {
    if(this.appState && this.appState.get("email") == "support@oryzasoft.com"){
